<?php
    ...
    $introduction = "初めはProgateで学習を始め、本格的にプログラミングを勉強したいと思いプログラミングスクールに通うことを決める。";
    ...
    <div class="portfolio">
        ...
        <div class="second" id="second">
            ...
            <div class="content">
                ...
                <!--自己紹介-->
                <div class="intro">
                    <p>自己紹介文:<?php echo $introduction; ?></p>
                </div>
                <!--メール-->
                <div class="email">
        ...
        <div class="third" id="third">
            ...
            <div class="content">
                ...
                <div class="project-list">
                    ...
                    <div class="Assemble">
                        <h3>Assemble</h3>
                        <p>音楽バンド向けマッチングアプリです。PHP / Laravel / phpmyadminを利用しています。</p>
                        <div class="Assemble-image">
                            <img src="/Portfolio/image/Assemble.png" alt="">
                        </div>
                    </div>
                    ...
                    <div class="project-footer">
                        ...
                        <!--開発中-->
                        <div class="develop">
                            <a href="/Portfolio/develop.php">開発中</a>
                        </div>
                    </div>
                </div>
